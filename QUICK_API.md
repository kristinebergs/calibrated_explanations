...
# column 1 contains the queried event probability; column 0 is its complement
...
print("P(y <= 120) =", p[0, 1], "interval =", plo[0], phi[0])
...
print("P(100 < y <= 140) =", p_in[0, 1], "interval =", ilo[0], ihi[0])
```
