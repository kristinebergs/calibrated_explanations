"""Conformal regions guard plugin for perturbation filtering.

This module provides ConformalRegionsGuardPlugin, a GuardPlugin implementation that
wraps ConformalRegionOracle to provide perturbation and candidate filtering
during explanation generation.

Part of Phase 3: Wrap ConformalRegionOracle as Guard Plugin (ADR-001, ADR-006).
"""
...
class ConformalRegionsGuardPlugin(GuardPlugin):
    """Plugin implementation of guard for conformal region filtering.
...
__all__ = ["ConformalRegionsGuardPlugin"]
