...
| Filter implausible perturbation rules in explanations | `explain_factual(..., guarded_options=GuardedOptions())` |
| Need guarded audit of removed rules | `explain_factual(..., guarded_options=GuardedOptions())` |
