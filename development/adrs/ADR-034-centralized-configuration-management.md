> **Active scope:** Governing architectural decision for `ConfigManager` and the centralized configuration surface. Gaps 1–2 are formally deferred post-v1.0 per §Open Items; remains active as long as `ConfigManager` governs CE configuration.
