> **Active scope:** Governing architectural decision for `data_modalities` declarations, the modality extension plugin contract, and optional modality extra packaging. The `data_modalities` enforcement gate (v0.11.4) is an implementation milestone within this ADR's lifecycle.
