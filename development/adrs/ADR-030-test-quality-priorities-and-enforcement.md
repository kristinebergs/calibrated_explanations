> **Active scope:** Governing architectural decision for the 90% coverage gate, test quality method (Options A/B/C cycle), and anti-pattern enforcement tooling. The test-quality-method documents are this ADR's governance tooling surface; remains active as long as these gates govern CE test strategy.
