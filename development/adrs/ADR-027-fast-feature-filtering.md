> **Active scope:** Governing architectural decision for the FAST-based internal feature-filtering design and per-batch per-instance filtering strategy. Remains active until the feature filtering implementation is complete and stable; subsequent revisions require a successor ADR.
