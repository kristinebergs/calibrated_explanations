...
The review confirms that `WrapCalibratedExplainer.explain_factual` docstring states the
API-contract scope and exchangeability assumption. See the curated evidence record for
reviewed doc paths, findings, and assumption boundary statement.
