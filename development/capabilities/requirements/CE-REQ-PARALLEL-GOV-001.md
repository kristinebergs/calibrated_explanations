...
- Deprecated `strategy="auto"` raises a `ConfigurationError` when enabled, while explicit strategies do not.
...
- Parallel strategy tests pass for explicit strategy resolution and configuration error behavior.
...
- pytest: tests/unit/perf/test_parallel.py::test_should_raise_when_strategy_auto_and_enabled
