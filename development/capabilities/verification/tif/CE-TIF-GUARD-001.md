# CE-TIF-GUARD-001 — Guarded Explanation TIF Verification Interface
...
|---|---|
| CE-REQ-GUARD-API-001 | `exception_raised`, `result_is_none`, `result_len` |
...
- `explainer.explain_factual(X_test, guarded_options=GuardedOptions())`
- `calibrated_explanations.GuardedOptions`
...
The TIF returns a `GuardObservation` dataclass with these fields:
...
|---|---|---|---|
| CE-REQ-GUARD-API-001 | API callable without exception | `exception_raised` | `False` |
| CE-REQ-GUARD-API-001 | Returns non-None | `result_is_none` | `False` |
| CE-REQ-GUARD-API-001 | Cardinality preserved | `result_len` | `== n_instances` |
