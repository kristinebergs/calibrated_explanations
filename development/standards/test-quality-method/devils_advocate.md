> **Active scope:** ADR-030 agent role: adversarially reviews proposed test changes for hidden risks, weak evidence, and potential coverage or behavior regressions. Remains active as long as this role is part of the quality improvement cycle.
...
1. **ADR-030** -- search in `development/adrs/` for the test quality
