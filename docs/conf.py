...
linkcheck_ignore = [
    ...
    # Maintainer-only development paths may not be present on the public default
    # branch at every release checkpoint. Suppress them in linkcheck so genuine
    # public-facing broken links are not masked by planning-tree churn.
