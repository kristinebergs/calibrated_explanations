...
1. Align with the active milestone in `development/current-work/vX.Y.Z_plan.md`
   (scoped per `development/current-work/RELEASE_PLAN.md`) and reference relevant ADRs.
