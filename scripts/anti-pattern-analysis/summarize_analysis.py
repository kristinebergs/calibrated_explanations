...
def summarize():
    ...
    print(
        "These are defined in src/ but only called from tests (or not at all). They can likely be deleted."
    )
    ...
    print(
        "These are defined in tests/ with a leading underscore. They should be renamed to public."
    )
    print("| Name | Definition File | Test Usages | Pattern |")
    print("| :--- | :--- | :--- | :--- |")
